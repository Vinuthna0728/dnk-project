    ...
    <header className="w-full bg-white border-b border-slate-200 sticky top-0 z-50">
      ...
      <div className="bg-[#1E3A8A] text-slate-200 text-xs py-1.5 px-4 sm:px-8 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4 text-xs">
          ...
          <Link href="/dwara/login" className="flex items-center gap-1 hover:text-white font-semibold">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        <Link href="/dwara/home" className="flex items-center gap-3">
        ...
        <nav className="hidden lg:flex items-center gap-6 font-bold text-xs uppercase tracking-wider text-slate-700">
          <Link href="/dwara/home" className="hover:text-[#2563EB] transition">Home</Link>
          <Link href="/dwara/verified-artisans" className="hover:text-[#2563EB] transition">Verified Artisans</Link>
          <Link href="/dwara/ondc-network" className="hover:text-[#2563EB] transition">ONDC Network</Link>
          <Link href="/dwara/customs-pbe3" className="hover:text-[#2563EB] transition">Customs PBE-III</Link>
        </nav>
                ...
                filteredProducts.map((product) => (
                  <div
                    ...
                    onClick={() => {
                      ...
                      router.push(`/dwara/product/${product.id}`);
                    }}
          ...
          <div className="bg-white w-full max-w-md h-full shadow-2xl flex flex-col justify-between p-6 border-l border-slate-200">
            ...
            <div className="pt-6 border-t border-slate-200">
              ...
              <button
                ...
                onClick={() => {
                  setIsCartOpen(false);
                  router.push(`/dwara/checkout?productId=${cartItems[0]?.id || ''}`);
                }}
