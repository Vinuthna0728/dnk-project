...
import AddressForm from "@/components/dwara/checkout/AddressForm";
import EscrowPaymentForm from "@/components/dwara/checkout/EscrowPaymentForm";
import OrderSummary from "@/components/dwara/checkout/OrderSummary";
import { MOCK_PRODUCTS } from "@/lib/dwara/mockData";
import { ShieldCheck } from "lucide-react";

export default function CheckoutPage({ searchParams }: { searchParams: { productId?: string } }) {
  const product = MOCK_PRODUCTS.find((p) => p.id === searchParams.productId) || MOCK_PRODUCTS[0];
